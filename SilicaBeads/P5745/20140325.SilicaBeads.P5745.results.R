...
# P5746: Neg. ctrl for P5744 (30 Mio. KBM7wt cells)
setwd("/slow/home/khoermann/MP/SilicaBeads/id.csv"); getwd(); 
id.files <- Sys.glob(c("P5745-[34].id.csv"))
...
write.csv2(result.df, file='20140325_Isobar_P5745.csv')
...
write.csv2(DF2, file="20140325.SilicaBeads.P5745-34.GOterms.csv")
