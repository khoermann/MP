...
id.files <- Sys.glob("/slow/home/khoermann/MP/SilicaBeads/P5573-[12].id.csv")
id.names <- gsub(".*/(P557[3])-[12].*","\\1",id.files)
id.names
...
head(go.terms.split)
writeIBSpectra(cbind(result.df,go.terms.split),file="20131203.SilicaBeads.P5573.results.csv",na="0")
system("/fast/bioinfo/sw/isobar/inst/pl/tab2xlsx.pl 20131203.SilicaBeads.P5573.results.csv")
