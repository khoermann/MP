...
-------------------------------------------------------------------------------------
  # Combination of data from 30*10^6 cells and 50*10^6 cells

library(isobar)

#list.files of interest /MP/SilicaBeads

getwd(); setwd("/slow/home/khoermann/MP/SilicaBeads/");
id.files <- Sys.glob("/slow/home/khoermann/MP/SilicaBeads/P557[12]-[12].id.csv")
id.names <- gsub(".*/(P557[12])-[12].*","\\1",id.files)
id.names
...
head(go.terms.split)
writeIBSpectra(cbind(result.df,go.terms.split),file="20131203.SilicaBeads.P5571-P5572.results.csv",na="0")
system("/fast/bioinfo/sw/isobar/inst/pl/tab2xlsx.pl 20131203.SilicaBeads.P5571-P5572.results.csv")
