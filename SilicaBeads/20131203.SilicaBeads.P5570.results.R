...
id.files <- Sys.glob("/slow/home/khoermann/MP/SilicaBeads/P5570-[12].id.csv")
...
head(go.terms.split)
writeIBSpectra(cbind(result.df,go.terms.split),file="20131203.SilicaBeads.P5570.results.csv",na="0")
system("/fast/bioinfo/sw/isobar/inst/pl/tab2xlsx.pl 20131203.SilicaBeads.P5570.results.csv")
