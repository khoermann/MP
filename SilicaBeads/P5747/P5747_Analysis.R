# Results for P5747: 
# P5747: 50 Mio KBM7 wt cells unlabeled ctrl

setwd("~/MP_RStudio_May2014/SilicaBeads/P5747/"); getwd();

# Read in the file created with "P5747_results.R" containing the GOCC annotation =========================================
annot <- read.csv2("~/MP_RStudio_May2014/SilicaBeads/P5747/P5747.GOterms.csv", header=T, stringsAsFactors=F)
dim(annot)
...
write.csv2(rbind(slc, abc), file="SLCsABCs_P5747.csv")  
...
P5747.itm <- subset(annot, matched_mask)   # No matches for this subset
dim(P5747.itm)

write.csv2(matches.pm.only, file="PMOnly_P5747.csv")
write.csv2(matches.pm, file="PM_P5747.csv")
write.csv2(non_PM_mem, file="Non_PM_mem_P5747.csv")
write.csv2(other, file="Other_P5747.csv")


# Plot sc distribution ========================================
pdf("~/MP_RStudio_May2014/CellSurfaceExtractionKit/P5747/GSC_distrib_P5747.pdf")
...
pdf("~/MP_RStudio_May2014/CellSurfaceExtractionKit/P5747/sc_distrib_vertical_P5747.pdf")
...
pdf("~/MP_RStudio_May2014/CellSurfaceExtractionKit/P5747/sc_distrib_horizontal_P5747.pdf")
boxplot(log10(matches.pm$global.spectra.count), log10(non_PM_mem$global.spectra.count), log10(other$global.spectra.count), 
        horizontal=T,
