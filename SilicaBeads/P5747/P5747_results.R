...
# P5747: 50 Mio. KBM7 wt cells unlabeled control
setwd("~/MP_RStudio_May2014/SilicaBeads/id.csv"); getwd(); 
id.files <- Sys.glob(c("P5747-[34].id.csv"))
...
dim(result.df)  # 1232 proteins detected
setwd("~/MP_RStudio_May2014/SilicaBeads/P5747/"); getwd(); 
write.csv2(result.df, file='Isobar_P5747.csv')
...
dim(combi)
write.csv2(combi, file="P5747.GOterms.csv")       # Contains 1197 entries
