...
# P5746: 30 Mio. KBM7 wt cells unlabeled control
setwd("~/MP_RStudio_May2014/SilicaBeads/id.csv"); getwd(); 
id.files <- Sys.glob(c("P5746-[34].id.csv"))
...
dim(result.df)  # 1221 proteins detected
setwd("~/MP_RStudio_May2014/SilicaBeads/P5746/"); getwd(); 
write.csv2(result.df, file='Isobar_P5746.csv')
...
dim(combi)
write.csv2(combi, file="P5746.GOterms.csv")       # Contains 1192 entries
