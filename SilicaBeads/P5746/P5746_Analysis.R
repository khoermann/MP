# Results for P5746: 
# P5746: 30 Mio KBM7 wt cells unlabeled ctrl

setwd("~/MP_RStudio_May2014/SilicaBeads/P5746/"); getwd();

# Read in the file created with "P5746_results.R" containing the GOCC annotation =========================================
annot <- read.csv2("~/MP_RStudio_May2014/SilicaBeads/P5746/P5746.GOterms.csv", header=T, stringsAsFactors=F)
dim(annot)
...
write.csv2(rbind(slc, abc), file="SLCsABCs_P5746.csv")  
...
P5746.itm <- subset(annot, matched_mask)   # No matches for this subset
dim(P5746.itm)

write.csv2(matches.pm.only, file="PMOnly_P5746.csv")
write.csv2(matches.pm, file="PM_P5746.csv")
write.csv2(non_PM_mem, file="Non_PM_mem_P5746.csv")
write.csv2(other, file="Other_P5746.csv")


# Plot sc distribution ========================================
pdf("~/MP_RStudio_May2014/CellSurfaceExtractionKit/P5746/GSC_distrib_P5746.pdf")
...
pdf("~/MP_RStudio_May2014/CellSurfaceExtractionKit/P5746/sc_distrib_vertical_P5746.pdf")
...
pdf("~/MP_RStudio_May2014/CellSurfaceExtractionKit/P5746/sc_distrib_horizontal_P5746.pdf")
