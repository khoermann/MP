# Results for P5455: 
# P5455: 120 Mio KBM7 wt cells labeled and processed according to Aminooxybiotin protocol

setwd("~/MP_RStudio_May2014/Aminooxybiotin/P5396_P5455/P5455/"); getwd();

# Read in the file created with "P5455_results.R" containing the GOCC annotation =========================================
annot <- read.csv2("~/MP_RStudio_May2014/Aminooxybiotin/P5396_P5455/P5455/P5455.GOterms.csv", header=T, stringsAsFactors=F)
dim(annot)
...
write.csv2(rbind(slc, abc), file="SLCsABCs_P5455.csv")  
...
P5455.itm <- subset(annot, matched_mask)   # No matches for this subset
dim(P5455.itm)

write.csv2(matches.pm.only, file="PMOnly_P5455.csv")
write.csv2(matches.pm, file="PM_P5455.csv")
write.csv2(non_PM_mem, file="Non_PM_mem_P5455.csv")
write.csv2(other, file="Other_P5455.csv")


# Plot sc distribution ========================================
pdf("~/MP_RStudio_May2014/CellSurfaceExtractionKit/P5455/GSC_distrib_P5455.pdf")
...
pdf("~/MP_RStudio_May2014/CellSurfaceExtractionKit/P5455/sc_distrib_vertical_P5455.pdf")
...
pdf("~/MP_RStudio_May2014/CellSurfaceExtractionKit/P5455/sc_distrib_horizontal_P5455.pdf")
