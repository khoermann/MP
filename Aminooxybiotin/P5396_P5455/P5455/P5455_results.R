...
# P5455: 120 Mio wt KBM7 cells labeled and processed according to Aminooxybiotin protocol
setwd("~/MP_RStudio_May2014/Aminooxybiotin/id.csv"); getwd(); 
id.files <- Sys.glob(c("P5455-[12].id.csv"))
...
dim(result.df)  # 314 proteins detected
setwd("~/MP_RStudio_May2014/Aminooxybiotin/P5396_P5455/P5455/"); getwd(); 
write.csv2(result.df, file='Isobar_P5455.csv')
...
dim(combi)
write.csv2(combi, file="P5455.GOterms.csv")       # Contains 312 entries
