# Results for P5396: 
# P5396: 120 Mio KBM7 wt cells labeled and processed according to Aminooxybiotin protocol

setwd("~/MP_RStudio_May2014/Aminooxybiotin/P5396_P5455/P5396/"); getwd();

# Read in the file created with "P5396_results.R" containing the GOCC annotation =========================================
annot <- read.csv2("~/MP_RStudio_May2014/Aminooxybiotin/P5396_P5455/P5396/P5396.GOterms.csv", header=T, stringsAsFactors=F)
dim(annot)
...
write.csv2(rbind(slc, abc), file="SLCsABCs_P5396.csv")  
...
P5396.itm <- subset(annot, matched_mask)   # No matches for this subset
dim(P5396.itm)

write.csv2(matches.pm.only, file="PMOnly_P5396.csv")
write.csv2(matches.pm, file="PM_P5396.csv")
write.csv2(non_PM_mem, file="Non_PM_mem_P5396.csv")
write.csv2(other, file="Other_P5396.csv")


# Plot sc distribution ========================================
pdf("~/MP_RStudio_May2014/CellSurfaceExtractionKit/P5396/GSC_distrib_P5396.pdf")
...
pdf("~/MP_RStudio_May2014/CellSurfaceExtractionKit/P5396/sc_distrib_vertical_P5396.pdf")
...
pdf("~/MP_RStudio_May2014/CellSurfaceExtractionKit/P5396/sc_distrib_horizontal_P5396.pdf")
boxplot(log10(matches.pm$global.spectra.count), log10(non_PM_mem$global.spectra.count), log10(other$global.spectra.count), 
        horizontal=T,
