...
# P5396: 120 Mio wt KBM7 cells labeled and processed according to Aminooxybiotin protocol
setwd("~/MP_RStudio_May2014/Aminooxybiotin/id.csv"); getwd(); 
id.files <- Sys.glob(c("P5396-[12].id.csv"))
...
dim(result.df)  # 49 proteins detected
setwd("~/MP_RStudio_May2014/Aminooxybiotin/P5396_P5455/P5396/"); getwd(); 
write.csv2(result.df, file='Isobar_P5396.csv')
...
dim(combi)
write.csv2(combi, file="P5396.GOterms.csv")       # Contains 47 entries
