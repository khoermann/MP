...
id.files <- Sys.glob(c("/slow/home/khoermann/MP/Aminooxybiotin/P5396-[12].id.csv","/slow/home/khoermann/MP/Aminooxybiotin/P5455-[12].id.csv"))
...
head(go.terms.split)
writeIBSpectra(cbind(result.df,go.terms.split),file="20131202.Aminooxy.P5396.P5455.results.csv",na="0")
system("/fast/bioinfo/sw/isobar/inst/pl/tab2xlsx.pl 20131202.Aminooxy.P5396.P5455.results.csv")
