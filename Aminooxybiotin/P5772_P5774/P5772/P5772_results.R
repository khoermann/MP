...
# P5772: 120 Mio wt KBM7 cells labeled and processed according to Aminooxybiotin protocol
setwd("~/MP_RStudio_May2014/Aminooxybiotin/id.csv"); getwd(); 
id.files <- Sys.glob(c("P5772-[34].id.csv"))
...
dim(result.df)  # 414 proteins detected
setwd("~/MP_RStudio_May2014/Aminooxybiotin/P5772_P5774/P5772/"); getwd(); 
write.csv2(result.df, file='Isobar_P5772.csv')
...
dim(combi)
write.csv2(combi, file="P5772.GOterms.csv")       # Contains 408 entries
