...
# P5774: 120 Mio wt KBM7 cells unlabeled ctrl
setwd("~/MP_RStudio_May2014/Aminooxybiotin/id.csv"); getwd(); 
id.files <- Sys.glob(c("P5774-[34].id.csv"))
...
dim(result.df)  # 494 proteins detected
setwd("~/MP_RStudio_May2014/Aminooxybiotin/P5772_P5774/P5774/"); getwd(); 
write.csv2(result.df, file='Isobar_P5774.csv')
...
dim(combi)
write.csv2(combi, file="P5774.GOterms.csv")       # Contains 488 entries
