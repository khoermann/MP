# Results for P5774: 
# P5774: 120 Mio KBM7 wt cells, unlabeled control

setwd("~/MP_RStudio_May2014/Aminooxybiotin/P5772_P5774/P5774/"); getwd();

# Read in the file created with "P5774_results.R" containing the GOCC annotation =========================================
annot <- read.csv2("~/MP_RStudio_May2014/Aminooxybiotin/P5772_P5774/P5774/P5774.GOterms.csv", header=T, stringsAsFactors=F)
dim(annot)
...
write.csv2(rbind(slc, abc), file="SLCsABCs_P5774.csv")  
...
P5774.itm <- subset(annot, matched_mask)   # No matches for this subset
dim(P5774.itm)

write.csv2(matches.pm.only, file="PMOnly_P5774.csv")
write.csv2(matches.pm, file="PM_P5774.csv")
write.csv2(non_PM_mem, file="Non_PM_mem_P5774.csv")
write.csv2(other, file="Other_P5774.csv")


# Plot sc distribution ========================================
pdf("~/MP_RStudio_May2014/CellSurfaceExtractionKit/P5774/GSC_distrib_P5774.pdf")
...
pdf("~/MP_RStudio_May2014/CellSurfaceExtractionKit/P5774/sc_distrib_vertical_P5774.pdf")
...
pdf("~/MP_RStudio_May2014/CellSurfaceExtractionKit/P5774/sc_distrib_horizontal_P5774.pdf")
boxplot(log10(matches.pm$global.spectra.count), log10(non_PM_mem$global.spectra.count), log10(other$global.spectra.count), 
        horizontal=T,
