...
#list.files of interest /MP/Aminooxybiotin/id.csv
# P5767: 120 Mio wt KBM7 cells labeled and processed according to Aminooxybiotin protocol
setwd("~/MP_RStudio_May2014/Aminooxybiotin/id.csv"); getwd(); 
id.files <- Sys.glob(c("P5767-[34].id.csv"))
...
dim(result.df)  # 401 proteins detected
setwd("~/MP_RStudio_May2014/Aminooxybiotin/P5767_P5768/P5767/"); getwd(); 
write.csv2(result.df, file='Isobar_P5767.csv')
...
dim(combi)
write.csv2(combi, file="P5767.GOterms.csv")       # Contains 396 entries
