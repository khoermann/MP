...
# P5768: 120 Mio wt KBM7 cells labeled and processed according to Aminooxybiotin protocol
setwd("~/MP_RStudio_May2014/Aminooxybiotin/id.csv"); getwd(); 
id.files <- Sys.glob(c("P5768-[34].id.csv"))
...
dim(result.df)  # 348 proteins detected
setwd("~/MP_RStudio_May2014/Aminooxybiotin/P5767_P5768/P5768/"); getwd(); 
write.csv2(result.df, file='Isobar_P5768.csv')
...
dim(combi)
write.csv2(combi, file="P5768.GOterms.csv")       # Contains 345 entries
