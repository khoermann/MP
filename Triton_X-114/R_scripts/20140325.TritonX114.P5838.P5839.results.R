...
id.files <- Sys.glob(c("P5838-[12].id.csv", "P5839-[12].id.csv"))
...
write.csv2(result.df, file='20140325_Isobar_P5838.P5839.csv')
...
write.csv2(DF2, file="20140325.TritonX114.P5838.P5839.GOterms.csv")
