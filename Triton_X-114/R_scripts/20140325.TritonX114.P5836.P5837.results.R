...
# P5836/P5837: detergent phases
setwd("/slow/home/khoermann/MP/Triton_X-114/id.csv"); getwd(); 
id.files <- Sys.glob(c("P5836-[12].id.csv", "P5837-[12].id.csv"))
...
write.csv2(result.df, file='20140325_Isobar_P5836.P5837.csv')
...
write.csv2(DF2, file="20140325.TritonX114.P5836.P5837.GOterms.csv")
