...
# P5836: 30 Mio wt cells subjected to phase separation +FASP, AQUEOUS PHASE
setwd("~/MP_RStudio_May2014/Triton_X-114/id.csv/"); getwd(); 
id.files <- Sys.glob(c("P5836-[12].id.csv"))
...
dim(result.df)  # 1695 proteins detected
setwd("~/MP_RStudio_May2014/Triton_X-114/P5836_5837/"); getwd(); 
write.csv2(result.df, file='Isobar_P5836.csv')
...
dim(combi)
write.csv2(combi, file="P5836.GOterms.csv")       # Contains 1656 entries
