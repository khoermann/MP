...
# P5837: 30 Mio wt cells subjected to phase separation +FASP, AQUEOUS PHASE, biological replicate of P5837
setwd("~/MP_RStudio_May2014/Triton_X-114/id.csv/"); getwd(); 
id.files <- Sys.glob(c("P5837-[12].id.csv"))
...
dim(result.df)  # 1690 proteins detected
setwd("~/MP_RStudio_May2014/Triton_X-114/P5837_5837/"); getwd(); 
write.csv2(result.df, file='Isobar_P5837.csv')
...
dim(combi)
write.csv2(combi, file="P5837.GOterms.csv")       # Contains 1648 entries
