# Results for P5839: 
# P5839: 30 Mio wt cells harvested and taken as control for phase separation experiments, biological replicate of P5838
# Triton X-114, unseparated control, FASP, 1-D shotgun, 2 injections

setwd("~/MP_RStudio_May2014/Triton_X-114/P5838_5839/"); getwd();

# Read in the file created with "P5839_results.R" containing the GOCC annotation =========================================
annot <- read.csv2("~/MP_RStudio_May2014/Triton_X-114/P5838_5839/P5839.GOterms.csv", header=T, stringsAsFactors=F)
dim(annot)
...
write.csv2(rbind(slc, abc), file="SLCsABCs_P5839.csv")  
...
P5839.itm <- subset(annot, matched_mask)   # No matches for this subset
dim(P5839.itm)

write.csv2(matches.pm.only, file="PMOnly_P5839.csv")
write.csv2(matches.pm, file="PM_P5839.csv")
write.csv2(non_PM_mem, file="Non_PM_mem_P5839.csv")
write.csv2(other, file="Other_P5839.csv")
write.csv2(mem, file="Membrane_P5839.csv")


# Plot sc distribution ========================================
pdf("~/MP_RStudio_May2014/Triton_X-114/P5834_5835/GSC_distrib_P5839.pdf")
...
pdf("~/MP_RStudio_May2014/Triton_X-114/P5834_5835//sc_distrib_vertical_P5839.pdf")
boxplot(log10(mem$global.spectra.count), log10(other$global.spectra.count), 
        ...
        col=c("red", "grey"), 
        main="Global Spectra Count distribution P5839")
dev.off()

# Horizontal version of the boxplot
pdf("~/MP_RStudio_May2014/Triton_X-114/P5834_5835//sc_distrib_horizontal_P5839.pdf")
boxplot(log10(mem$global.spectra.count), log10(other$global.spectra.count), 
        horizontal=T,
        ylab="Log10(Global Spectra Counts)", 
        names=c("Membrane", "Non-membrane"),
