...
# P5839: 30 Mio wt cells NOT subjected to phase separation +FASP, control
setwd("~/MP_RStudio_May2014/Triton_X-114/id.csv/"); getwd(); 
id.files <- Sys.glob(c("P5839-[12].id.csv"))
...
dim(result.df)  # 1838 proteins detected
setwd("~/MP_RStudio_May2014/Triton_X-114/P5838_5839/"); getwd(); 
write.csv2(result.df, file='Isobar_P5839.csv')
...
dim(combi)
write.csv2(combi, file="P5839.GOterms.csv")       # Contains 1804 entries
