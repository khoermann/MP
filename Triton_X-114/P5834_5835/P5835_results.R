...
id.files <- Sys.glob(c("P5835-[12].id.csv"))
...
dim(result.df)  # 1733 proteins detected
setwd("~/MP_RStudio_May2014/Triton_X-114/P5834_5835/"); getwd(); 
write.csv2(result.df, file='Isobar_P5835.csv')
...
dim(combi)
write.csv2(combi, file="P5835.GOterms.csv")       # Contains 1692 entries
