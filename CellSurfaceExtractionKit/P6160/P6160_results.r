...
# P6160: unlabelled control, Biotin elution
setwd("H:/MP/PierceKit/dat/id.csv"); getwd(); 
id.files <- Sys.glob(c("P6160-[12].id.csv"))
...
write.csv2(result.df, file='Isobar_P6160.csv')
...
write.csv2(combi, file="P6160.GOterms.csv")       # Contains 29 entries
