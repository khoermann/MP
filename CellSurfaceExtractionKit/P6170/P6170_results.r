...
# P6170: unlabelled control, SDS elution
setwd("H:/MP/PierceKit/dat/id.csv"); getwd(); 
id.files <- Sys.glob(c("P6170-[12].id.csv"))
...
write.csv2(result.df, file='Isobar_P6170.csv')
...
write.csv2(combi, file="P6170.GOterms.csv")       # Contains 72 entries
