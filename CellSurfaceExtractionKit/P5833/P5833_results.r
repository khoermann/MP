...
# P5833: unlabeled control, Cell Surface Extraction Kit, Biotin elution
setwd("~/MP_RStudio_May2014/CellSurfaceExtractionKit//id.csv"); getwd(); 
id.files <- Sys.glob(c("P5833-[12].id.csv"))
...
dim(result.df)  # 341 proteins detected
setwd("~/MP_RStudio_May2014/CellSurfaceExtractionKit/P5833/"); getwd(); 
write.csv2(result.df, file='Isobar_P5833.csv')
...
dim(combi)
write.csv2(combi, file="P5833.GOterms.csv")       # Contains 332 entries
