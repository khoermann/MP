...
# P6158: labelled sample, PM extracted with Pierce kit, Biotin elution
setwd("H:/MP/PierceKit/dat/id.csv"); getwd(); 
id.files <- Sys.glob(c("P6158-[12].id.csv"))
...
write.csv2(result.df, file='Isobar_P6158.csv')
...
write.csv2(combi, file="P6158.GOterms.csv")       # Contains 196 entries
