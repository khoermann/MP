...
# P5829: unlabeled control, + TX-114 phase separation, DETERGENT phase
setwd("~/MP_RStudio_May2014/CellSurfaceExtractionKit//id.csv"); getwd(); 
id.files <- Sys.glob(c("P5829-[12].id.csv"))
...
dim(result.df)  # 544 proteins detected
setwd("~/MP_RStudio_May2014/CellSurfaceExtractionKit/P5829/"); getwd(); 
write.csv2(result.df, file='Isobar_P5829.csv')
...
dim(combi)
write.csv2(combi, file="P5829.GOterms.csv")       # Contains 541 entries
