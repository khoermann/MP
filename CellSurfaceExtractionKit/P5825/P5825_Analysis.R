...
setwd("~/MP_RStudio_May2014/CellSurfaceExtractionKit/P5825/"); getwd();

# Read in the file created with "P5825_results.R" containing the GOCC annotation =========================================
annot <- read.csv2("~/MP_RStudio_May2014/CellSurfaceExtractionKit/P5825//P5825.GOterms.csv", header=T, stringsAsFactors=F)
dim(annot)
...
write.csv2(rbind(slc, abc), file="SLCsABCs_P5825.csv")  


# Divide into GOCC subgroups ----------------------------------
mem <- annot[grep('membrane', annot$Go.Cc), ]   # 215 proteins
dim(mem)
...
P5825.itm <- subset(annot, matched_mask)   # No matches for this subset
dim(P5825.itm)

write.csv2(matches.pm.only, file="PMOnly_P5825.csv")
write.csv2(matches.pm, file="PM_P5825.csv")
write.csv2(non_PM_mem, file="Non_PM_mem_P5825.csv")
write.csv2(other, file="Other_P5825.csv")


# Plot sc distribution ========================================
pdf("~/MP_RStudio_May2014/CellSurfaceExtractionKit/P5825/GSC_distrib_P5825.pdf")
...
pdf("~/MP_RStudio_May2014/CellSurfaceExtractionKit/P5825/sc_distrib_vertical_P5825.pdf")
...
pdf("~/MP_RStudio_May2014/CellSurfaceExtractionKit/P5825/sc_distrib_horizontal_P5825.pdf")
boxplot(log10(matches.pm$global.spectra.count), log10(non_PM_mem$global.spectra.count), log10(other$global.spectra.count), 
        horizontal=T,
