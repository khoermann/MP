...
# P5825: unlabeled control, pre-deglycosylated
setwd("~/MP_RStudio_May2014/CellSurfaceExtractionKit//id.csv"); getwd(); 
id.files <- Sys.glob(c("P5825-[12].id.csv"))
...
write.csv2(result.df, file='Isobar_P5825.csv')
...
dim(combi)
write.csv2(combi, file="P5825.GOterms.csv")       # Contains 541 entries
