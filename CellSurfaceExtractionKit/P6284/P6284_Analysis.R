...
# Read in the file created with "P6284_results.R" containing the GOCC annotation =========================================
annot <- read.csv2("~/MP_RStudio_May2014/CellSurfaceExtractionKit/P6284//P6284.GOterms.csv", header=T, stringsAsFactors=F)
dim(annot)
...
write.csv2(rbind(slc, abc), file="SLCsABCs_P6284.csv")  
...
P6284.itm <- subset(annot, matched_mask)   # No matches for this subset
dim(P6284.itm)

write.csv2(matches.pm.only, file="PMOnly_P6284.csv")
write.csv2(matches.pm, file="PM_P6284.csv")
write.csv2(non_PM_mem, file="Non_PM_mem_P6284.csv")
write.csv2(other, file="Other_P6284.csv")


# Plot sc distribution ========================================
pdf("~/MP_RStudio_May2014/CellSurfaceExtractionKit/P6284/GSC_distrib_P6284.pdf")
...
pdf("~/MP_RStudio_May2014/CellSurfaceExtractionKit/P6284/sc_distrib_vertical_P6284.pdf")
...
pdf("~/MP_RStudio_May2014/CellSurfaceExtractionKit/P6284/sc_distrib_horizontal_P6284.pdf")
boxplot(log10(matches.pm$global.spectra.count), log10(non_PM_mem$global.spectra.count), log10(other$global.spectra.count), 
        horizontal=T,
