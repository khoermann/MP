...
# P5827: unlabeled control, pre-deglycosylated
setwd("~/MP_RStudio_May2014/CellSurfaceExtractionKit//id.csv"); getwd(); 
id.files <- Sys.glob(c("P5827-[12].id.csv"))
...
dim(result.df)  # 546 proteins detected
setwd("~/MP_RStudio_May2014/CellSurfaceExtractionKit/P5827/"); getwd(); 
write.csv2(result.df, file='Isobar_P5827.csv')
...
dim(combi)
write.csv2(combi, file="P5827.GOterms.csv")       # Contains 541 entries
