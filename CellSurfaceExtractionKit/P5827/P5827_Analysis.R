...
setwd("~/MP_RStudio_May2014/CellSurfaceExtractionKit/P5827/"); getwd();

# Read in the file created with "P5827_results.R" containing the GOCC annotation =========================================
annot <- read.csv2("~/MP_RStudio_May2014/CellSurfaceExtractionKit/P5827//P5827.GOterms.csv", header=T, stringsAsFactors=F)
dim(annot)
...
write.csv2(rbind(slc, abc), file="SLCsABCs_P5827.csv")  
...
P5827.itm <- subset(annot, matched_mask)   # No matches for this subset
dim(P5827.itm)

write.csv2(matches.pm.only, file="PMOnly_P5827.csv")
write.csv2(matches.pm, file="PM_P5827.csv")
write.csv2(non_PM_mem, file="Non_PM_mem_P5827.csv")
write.csv2(other, file="Other_P5827.csv")


# Plot sc distribution ========================================
pdf("~/MP_RStudio_May2014/CellSurfaceExtractionKit/P5827/GSC_distrib_P5827.pdf")
...
pdf("~/MP_RStudio_May2014/CellSurfaceExtractionKit/P5827/sc_distrib_vertical_P5827.pdf")
...
pdf("~/MP_RStudio_May2014/CellSurfaceExtractionKit/P5827/sc_distrib_horizontal_P5827.pdf")
boxplot(log10(matches.pm$global.spectra.count), log10(non_PM_mem$global.spectra.count), log10(other$global.spectra.count), 
        horizontal=T,
