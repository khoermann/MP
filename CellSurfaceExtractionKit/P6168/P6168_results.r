...
# P6168: biotinylated, SDS elution
setwd("H:/MP/PierceKit/dat/id.csv"); getwd(); 
id.files <- Sys.glob(c("P6168-[12].id.csv"))
...
setwd("~/MP_RStudio_May2014/CellSurfaceExtractionKit/P6168/"); getwd(); 
write.csv2(result.df, file='Isobar_P6168.csv')
...
write.csv2(combi, file="P6168.GOterms.csv")       # Contains 61 entries
