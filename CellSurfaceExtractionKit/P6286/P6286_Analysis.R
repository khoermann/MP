# Results for P6286: 
# P6286: 40 Mio wt cells labeled, Cell Surface Extraction Kit, washing with 8M Guanidin HCl, Biotin elution
# Cell Surface Protein Extraction Kit, Biotin elution, 1-D shotgun, 2 injections

setwd("~/MP_RStudio_May2014/CellSurfaceExtractionKit/P6286/"); getwd();

# Read in the file created with "P6286_results.R" containing the GOCC annotation =========================================
annot <- read.csv2("~/MP_RStudio_May2014/CellSurfaceExtractionKit/P6286//P6286.GOterms.csv", header=T, stringsAsFactors=F)
dim(annot)
...
write.csv2(rbind(slc, abc), file="SLCsABCs_P6286.csv")  
...
P6286.itm <- subset(annot, matched_mask)   # No matches for this subset
dim(P6286.itm)

write.csv2(matches.pm.only, file="PMOnly_P6286.csv")
write.csv2(matches.pm, file="PM_P6286.csv")
write.csv2(non_PM_mem, file="Non_PM_mem_P6286.csv")
write.csv2(other, file="Other_P6286.csv")


# Plot sc distribution ========================================
pdf("~/MP_RStudio_May2014/CellSurfaceExtractionKit/P6286/GSC_distrib_P6286.pdf")
...
pdf("~/MP_RStudio_May2014/CellSurfaceExtractionKit/P6286/sc_distrib_vertical_P6286.pdf")
...
pdf("~/MP_RStudio_May2014/CellSurfaceExtractionKit/P6286/sc_distrib_horizontal_P6286.pdf")
boxplot(log10(matches.pm$global.spectra.count), log10(non_PM_mem$global.spectra.count), log10(other$global.spectra.count), 
        horizontal=T,
