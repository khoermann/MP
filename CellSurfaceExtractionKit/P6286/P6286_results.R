...
id.files <- Sys.glob(c("P6286-[12].id.csv"))
...
dim(result.df)  # 87 proteins detected
setwd("~/MP_RStudio_May2014/CellSurfaceExtractionKit/P6286/"); getwd(); 
write.csv2(result.df, file='Isobar_P6286.csv')
...
dim(combi)
write.csv2(combi, file="P6286.GOterms.csv")       # Contains 85 entries
