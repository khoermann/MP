...
# P5828: biotinylated + TX-114 phase separation (detergent phase)
setwd("/slow/home/khoermann/MP/CellSurfaceExtractionKit/id.csv/"); getwd(); 
id.files <- Sys.glob(c("P5828-[12].id.csv"))
...
write.csv2(result.df, file='20140325_Isobar_P5828.csv')
...
write.csv2(DF2, file="20140325.Kit.P5828.GOterms.csv")
