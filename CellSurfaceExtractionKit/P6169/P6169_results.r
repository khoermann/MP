...
# P6169: biotinylated, SDS elution
setwd("H:/MP/PierceKit/dat/id.csv"); getwd(); 
id.files <- Sys.glob(c("P6169-[12].id.csv"))
...
write.csv2(result.df, file='Isobar_P6169.csv')
...
write.csv2(combi, file="P6169.GOterms.csv")       # Contains 36 entries
