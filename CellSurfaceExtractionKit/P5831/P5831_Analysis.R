# Results for P5831: 
# Negative control for P5830. Unlabeled control
# Cell Surface Protein Extraction Kit, SDS elution, + TX-114 phase separation, AQUEOUS phase, 1-D shotgun, 2 injections

setwd("~/MP_RStudio_May2014/CellSurfaceExtractionKit/P5831/"); getwd();

# Read in the file created with "P5831_results.R" containing the GOCC annotation =========================================
annot <- read.csv2("~/MP_RStudio_May2014/CellSurfaceExtractionKit/P5831//P5831.GOterms.csv", header=T, stringsAsFactors=F)
dim(annot)
...
write.csv2(rbind(slc, abc), file="SLCsABCs_P5831.csv")  
...
P5831.itm <- subset(annot, matched_mask)   # No matches for this subset
dim(P5831.itm)

write.csv2(matches.pm.only, file="PMOnly_P5831.csv")
write.csv2(matches.pm, file="PM_P5831.csv")
write.csv2(non_PM_mem, file="Non_PM_mem_P5831.csv")
write.csv2(other, file="Other_P5831.csv")


# Plot sc distribution ========================================
pdf("~/MP_RStudio_May2014/CellSurfaceExtractionKit/P5831/GSC_distrib_P5831.pdf")
...
pdf("~/MP_RStudio_May2014/CellSurfaceExtractionKit/P5831/sc_distrib_vertical_P5831.pdf")
...
pdf("~/MP_RStudio_May2014/CellSurfaceExtractionKit/P5831/sc_distrib_horizontal_P5831.pdf")
boxplot(log10(matches.pm$global.spectra.count), log10(non_PM_mem$global.spectra.count), log10(other$global.spectra.count), 
        horizontal=T,
