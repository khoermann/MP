...
# P5831: unlabeled control, + TX-114 phase separation, AQUEOUS phase
setwd("~/MP_RStudio_May2014/CellSurfaceExtractionKit//id.csv"); getwd(); 
id.files <- Sys.glob(c("P5831-[12].id.csv"))
...
write.csv2(result.df, file='Isobar_P5831.csv')
...
dim(combi)
write.csv2(combi, file="P5831.GOterms.csv")       # Contains 406 entries
