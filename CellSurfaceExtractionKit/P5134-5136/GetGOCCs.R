...
#list.files("/slow/home/khoermann",pattern="P513[4567]-1.id.csv",full.names=TRUE)

id.files <- Sys.glob("/slow/home/khoermann/P513[4567]-[12].id.csv")
...
head(go.terms.split)
writeIBSpectra(cbind(result.df,go.terms.split),file="20130705.mp.results.csv",na="0")
system("/fast/bioinfo/sw/isobar/inst/pl/tab2xlsx.pl 20130705.mp.results.csv")
