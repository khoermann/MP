...
# P5134: 40 Mio wt cells labeled, Cell Surface Extraction Kit, SDS elution
setwd("~/MP_RStudio_May2014/CellSurfaceExtractionKit//id.csv"); getwd(); 
id.files <- Sys.glob(c("P5134-[12].id.csv"))
...
dim(result.df)  # 1718 proteins detected
setwd("~/MP_RStudio_May2014/CellSurfaceExtractionKit/P5134-5136/"); getwd(); 
write.csv2(result.df, file='Isobar_P5134.csv')
...
dim(combi)
write.csv2(combi, file="P5134.GOterms.csv")       # Contains 1656 entries
