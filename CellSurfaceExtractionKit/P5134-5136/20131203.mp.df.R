...
#list.files("/fast/masspec/identifications/protSpectra",pattern="P513[4567]-1.id.csv",full.names=TRUE)

id.files <- Sys.glob("/fast/masspec/identifications/protSpectra/P513[4567]-[12].id.csv")
...
head(go.terms.split)
writeIBSpectra(cbind(result.df,go.terms.split),file="20131203.Kit.results.csv",na="0")
system("/fast/bioinfo/sw/isobar/inst/pl/tab2xlsx.pl 20131203.Kit.results.csv")
