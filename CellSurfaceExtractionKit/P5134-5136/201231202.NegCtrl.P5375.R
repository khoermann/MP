...
id.files <- Sys.glob("/slow/home/khoermann/MP/P5375-[12].id.csv")
id.names <- gsub(".*/(P5375)-[12].*","\\1",id.files)
id.names
...
head(go.terms.split)
writeIBSpectra(cbind(result.df,go.terms.split),file="20131202.NegCtrl.P5375.results.csv",na="0")
system("/fast/bioinfo/sw/isobar/inst/pl/tab2xlsx.pl 20131202.NegCtrl.P5375.results.csv")
