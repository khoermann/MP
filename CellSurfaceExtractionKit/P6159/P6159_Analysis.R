# Results for P6159. 
# Neg ctrl for P6159: Unlabelled ctrl, Cell Surface Protein Extraction Kit, Biotin elution, 1-D shotgun, 2 injections

setwd("~/MP_RStudio_May2014/CellSurfaceExtractionKit/P6159/"); getwd();

# Read in the file created with "P6159_results.R" containing the GOCC annotation =========================================
annot <- read.csv2("~/MP_RStudio_May2014/CellSurfaceExtractionKit/P6159//P6159.GOterms.csv", header=T, stringsAsFactors=F)
...
write.csv2(rbind(slc, abc), file="SLCsABCs_P6159.csv")  


# Divide into GOCC subgroups ----------------------------------
mem <- annot[grep('membrane', annot$Go.Cc), ]   # 25 proteins

# PM only
PM.only <- c('plasma membrane', 'cell surface', 'cell membrane')
matches.pm.only <- annot[grep(paste(PM.only, collapse='|'), annot$Go.Cc), ]; dim(matches.pm.only)  # 20 matches
...
P6159.itm <- subset(annot, matched_mask)   # No matches for this subset

write.csv2(matches.pm.only, file="PMOnly_P6159.csv")
write.csv2(matches.pm, file="PM_P6159.csv")
write.csv2(non_PM_mem, file="Non_PM_mem_P6159.csv")
write.csv2(other, file="Other_P6159.csv")


# Plot sc distribution ========================================
pdf("~/MP_RStudio_May2014/CellSurfaceExtractionKit/P6159/GSC_distrib_P6159.pdf")
...
pdf("~/MP_RStudio_May2014/CellSurfaceExtractionKit/P6159/sc_distrib_vertical_P6159.pdf")
...
pdf("~/MP_RStudio_May2014/CellSurfaceExtractionKit/P6159/sc_distrib_horizontal_P6159.pdf")
boxplot(log10(matches.pm$global.spectra.count), log10(non_PM_mem$global.spectra.count), log10(other$global.spectra.count), 
        horizontal=T,
