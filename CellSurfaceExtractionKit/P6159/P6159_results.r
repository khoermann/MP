...
# P6159: unlabelled control, Biotin elution
setwd("H:/MP/PierceKit/dat/id.csv"); getwd(); 
id.files <- Sys.glob(c("P6159-[12].id.csv"))
...
write.csv2(result.df, file='Isobar_P6159.csv')
...
write.csv2(combi, file="P6159.GOterms.csv")       # Contains 72 entries
