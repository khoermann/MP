# Results for P6171. 
# Neg ctrl for P6171: Unlabelled ctrl, Cell Surface Protein Extraction Kit, SDS elution, 1-D shotgun, 2 injections

setwd("~/MP_RStudio_May2014/CellSurfaceExtractionKit/P6171/"); getwd();

# Read in the file created with "P6171_results.R" containing the GOCC annotation =========================================
annot <- read.csv2("~/MP_RStudio_May2014/CellSurfaceExtractionKit/P6171//P6171.GOterms.csv", header=T, stringsAsFactors=F)
...
write.csv2(rbind(slc, abc), file="SLCsABCs_P6171.csv")  


# Divide into GOCC subgroups ----------------------------------
mem <- annot[grep('membrane', annot$Go.Cc), ]   # 0 proteins
...
P6171.itm <- subset(annot, matched_mask)   # No matches for this subset

write.csv2(matches.pm.only, file="PMOnly_P6171.csv")
write.csv2(matches.pm, file="PM_P6171.csv")
# write.csv2(non_PM_mem, file="Non_PM_mem_P6171.csv")
write.csv2(other, file="Other_P6171.csv")


# Plot sc distribution ========================================
pdf("~/MP_RStudio_May2014/CellSurfaceExtractionKit/P6171/GSC_distrib_P6171.pdf")
...
pdf("~/MP_RStudio_May2014/CellSurfaceExtractionKit/P6171/sc_distrib_vertical_P6171.pdf")
...
pdf("~/MP_RStudio_May2014/CellSurfaceExtractionKit/P6171/sc_distrib_horizontal_P6171.pdf")
boxplot(log10(matches.pm$global.spectra.count), log10(non_PM_mem$global.spectra.count), log10(other$global.spectra.count), 
        horizontal=T,
