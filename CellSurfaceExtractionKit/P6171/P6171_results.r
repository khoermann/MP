...
# P6171: unlabelled control, SDS elution
setwd("H:/MP/PierceKit/dat/id.csv"); getwd(); 
id.files <- Sys.glob(c("P6171-[12].id.csv"))
...
write.csv2(result.df, file='Isobar_P6171.csv')
...
write.csv2(combi, file="P6171.GOterms.csv")       # Contains 1 entries
